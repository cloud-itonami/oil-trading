...
(defn collection
  [name]
  (str "com.etzhayyim.oil-trading." name))

(def cell-specs {
  :gettrade {:legacy-cell "com-etzhayyim-apps-oilTrading-book-getTrade"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "gettrade")]
     :required-gates common-gates
     :trigger "manifest cell gettrade"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listtrades {:legacy-cell "com-etzhayyim-apps-oilTrading-book-listTrades"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listtrades")]
     :required-gates common-gates
     :trigger "manifest cell listtrades"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listofftakes {:legacy-cell "com-etzhayyim-apps-oilTrading-book-listOfftakes"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listofftakes")]
     :required-gates common-gates
     :trigger "manifest cell listofftakes"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getbenchmarkexposure {:legacy-cell "com-etzhayyim-apps-oilTrading-analytics-getBenchmarkExposure"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getbenchmarkexposure")]
     :required-gates common-gates
     :trigger "manifest cell getbenchmarkexposure"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-oilTrading-health"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :trade {:legacy-cell "com-etzhayyim-apps-oilTrading-trade"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "trade")]
     :required-gates common-gates
     :trigger "manifest cell trade"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :offtakecontract {:legacy-cell "com-etzhayyim-apps-oilTrading-offtakeContract"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "offtakecontract")]
     :required-gates common-gates
     :trigger "manifest cell offtakecontract"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
